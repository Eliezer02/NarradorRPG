...
const GamePage: React.FC = () => {
  ...
  const handleSaveAdventure = useCallback(async () => {
    ...
    const payload = {
      ...
      messages: messages.filter(msg => msg.id !== 'start-prompt'),
      storyLog: storyLog,
  ...
  const sendMessage = useCallback(async (text: string) => {
    ...
    // A resposta agora é um objeto { text, source }, e nós registramos a fonte no console.
    // ====================================================================================
    ...
    console.log(`Response generated by: ${response.source}`);
